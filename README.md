...
```sh
grep -rl 'hesam' ./ | xargs sed -i '' 's/hesam/{YOUR INTEGRATION NAME}/g'
```
...
## Vue Storefront 2 integration with hesam
...
Want to contribute? Ping us on `hesam` channel on [our Discord](https://discord.vuestorefront.io)!
...
2. Clone your fork of the repo
    ```
    example:
    git clone https://github.com/vuestorefront/hesam.git
    cd hesam
    ```
...
- [hesam integration Documentation](https://docs.vuestorefront.io/hesam)
- [Community Chat](https://discord.vuestorefront.io)

## Support

If you have any questions about this integration we will be happy to answer them on `hesam` channel on [our Discord](discord.vuestorefront.io).
